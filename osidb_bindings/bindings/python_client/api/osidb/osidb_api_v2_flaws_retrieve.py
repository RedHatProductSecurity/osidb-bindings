...
from ...models.osidb_api_v2_flaws_retrieve_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "url": f"{client.base_url}/osidb/api/v2/flaws/{id}".format(
            id=id,
        ),
        "params": params,
    }
...
) -> Optional[OsidbApiV2FlawsRetrieveResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: OsidbApiV2FlawsRetrieveResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2FlawsRetrieveResponse200.from_dict(_response_200)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2FlawsRetrieveResponse200]:
    return Response(
