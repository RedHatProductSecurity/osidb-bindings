...
from ...models.osidb_api_v1_flaws_list_affects_affectedness import OsidbApiV1FlawsListAffectsAffectedness
...
from ...models.osidb_api_v1_flaws_list_cvss_scores_issuer import OsidbApiV1FlawsListCvssScoresIssuer
from ...models.osidb_api_v1_flaws_list_impact import OsidbApiV1FlawsListImpact
from ...models.osidb_api_v1_flaws_list_major_incident_state import OsidbApiV1FlawsListMajorIncidentState
from ...models.osidb_api_v1_flaws_list_nist_cvss_validation import OsidbApiV1FlawsListNistCvssValidation
...
from ...models.osidb_api_v1_flaws_list_requires_cve_description import OsidbApiV1FlawsListRequiresCveDescription
...
from ...models.osidb_api_v1_flaws_list_workflow_state_item import OsidbApiV1FlawsListWorkflowStateItem
...
def _get_kwargs(
    *,
    ...
    requires_cve_description: Union[Unset, OsidbApiV1FlawsListRequiresCveDescription] = UNSET,
    ...
    if not isinstance(acknowledgments_created_dt_date, Unset):
        json_acknowledgments_created_dt_date = acknowledgments_created_dt_date.isoformat()
    ...
    if not isinstance(acknowledgments_created_dt_date_gte, Unset):
        json_acknowledgments_created_dt_date_gte = acknowledgments_created_dt_date_gte.isoformat()

    params["acknowledgments__created_dt__date__gte"] = json_acknowledgments_created_dt_date_gte
    ...
    if not isinstance(acknowledgments_created_dt_date_lte, Unset):
        json_acknowledgments_created_dt_date_lte = acknowledgments_created_dt_date_lte.isoformat()

    params["acknowledgments__created_dt__date__lte"] = json_acknowledgments_created_dt_date_lte
    ...
    if not isinstance(acknowledgments_updated_dt_date, Unset):
        json_acknowledgments_updated_dt_date = acknowledgments_updated_dt_date.isoformat()
    ...
    if not isinstance(acknowledgments_updated_dt_date_gte, Unset):
        json_acknowledgments_updated_dt_date_gte = acknowledgments_updated_dt_date_gte.isoformat()

    params["acknowledgments__updated_dt__date__gte"] = json_acknowledgments_updated_dt_date_gte
    ...
    if not isinstance(acknowledgments_updated_dt_date_lte, Unset):
        json_acknowledgments_updated_dt_date_lte = acknowledgments_updated_dt_date_lte.isoformat()

    params["acknowledgments__updated_dt__date__lte"] = json_acknowledgments_updated_dt_date_lte
    ...
    if not isinstance(affects_affectedness, Unset):
        json_affects_affectedness = OsidbApiV1FlawsListAffectsAffectedness(affects_affectedness).value
    ...
    if not isinstance(affects_resolution, Unset):
        json_affects_resolution = OsidbApiV1FlawsListAffectsResolution(affects_resolution).value
    ...
    if not isinstance(affects_trackers_created_dt_date, Unset):
        json_affects_trackers_created_dt_date = affects_trackers_created_dt_date.isoformat()

    params["affects__trackers__created_dt__date"] = json_affects_trackers_created_dt_date
    ...
    if not isinstance(affects_trackers_created_dt_date_gte, Unset):
        json_affects_trackers_created_dt_date_gte = affects_trackers_created_dt_date_gte.isoformat()

    params["affects__trackers__created_dt__date__gte"] = json_affects_trackers_created_dt_date_gte
    ...
    if not isinstance(affects_trackers_created_dt_date_lte, Unset):
        json_affects_trackers_created_dt_date_lte = affects_trackers_created_dt_date_lte.isoformat()

    params["affects__trackers__created_dt__date__lte"] = json_affects_trackers_created_dt_date_lte
    ...
    if not isinstance(affects_trackers_created_dt_gte, Unset):
        json_affects_trackers_created_dt_gte = affects_trackers_created_dt_gte.isoformat()
    ...
    if not isinstance(affects_trackers_created_dt_lte, Unset):
        json_affects_trackers_created_dt_lte = affects_trackers_created_dt_lte.isoformat()
    ...
    if not isinstance(affects_trackers_errata_shipped_dt, Unset):
        json_affects_trackers_errata_shipped_dt = affects_trackers_errata_shipped_dt.isoformat()

    params["affects__trackers__errata__shipped_dt"] = json_affects_trackers_errata_shipped_dt
    ...
    if not isinstance(affects_trackers_errata_shipped_dt_date, Unset):
        json_affects_trackers_errata_shipped_dt_date = affects_trackers_errata_shipped_dt_date.isoformat()

    params["affects__trackers__errata__shipped_dt__date"] = json_affects_trackers_errata_shipped_dt_date
    ...
    if not isinstance(affects_trackers_errata_shipped_dt_date_gte, Unset):
        json_affects_trackers_errata_shipped_dt_date_gte = affects_trackers_errata_shipped_dt_date_gte.isoformat()

    params["affects__trackers__errata__shipped_dt__date__gte"] = json_affects_trackers_errata_shipped_dt_date_gte
    ...
    if not isinstance(affects_trackers_errata_shipped_dt_date_lte, Unset):
        json_affects_trackers_errata_shipped_dt_date_lte = affects_trackers_errata_shipped_dt_date_lte.isoformat()

    params["affects__trackers__errata__shipped_dt__date__lte"] = json_affects_trackers_errata_shipped_dt_date_lte
    ...
    if not isinstance(affects_trackers_errata_shipped_dt_gt, Unset):
        json_affects_trackers_errata_shipped_dt_gt = affects_trackers_errata_shipped_dt_gt.isoformat()

    params["affects__trackers__errata__shipped_dt__gt"] = json_affects_trackers_errata_shipped_dt_gt
    ...
    if not isinstance(affects_trackers_errata_shipped_dt_gte, Unset):
        json_affects_trackers_errata_shipped_dt_gte = affects_trackers_errata_shipped_dt_gte.isoformat()
    ...
    if not isinstance(affects_trackers_errata_shipped_dt_lt, Unset):
        json_affects_trackers_errata_shipped_dt_lt = affects_trackers_errata_shipped_dt_lt.isoformat()

    params["affects__trackers__errata__shipped_dt__lt"] = json_affects_trackers_errata_shipped_dt_lt
    ...
    if not isinstance(affects_trackers_errata_shipped_dt_lte, Unset):
        json_affects_trackers_errata_shipped_dt_lte = affects_trackers_errata_shipped_dt_lte.isoformat()

    params["affects__trackers__errata__shipped_dt__lte"] = json_affects_trackers_errata_shipped_dt_lte

    params["affects__trackers__external_system_id"] = affects_trackers_external_system_id
    ...
    if not isinstance(affects_trackers_type, Unset):
        json_affects_trackers_type = OsidbApiV1FlawsListAffectsTrackersType(affects_trackers_type).value
    ...
    if not isinstance(affects_trackers_updated_dt_date, Unset):
        json_affects_trackers_updated_dt_date = affects_trackers_updated_dt_date.isoformat()

    params["affects__trackers__updated_dt__date"] = json_affects_trackers_updated_dt_date
    ...
    if not isinstance(affects_trackers_updated_dt_date_gte, Unset):
        json_affects_trackers_updated_dt_date_gte = affects_trackers_updated_dt_date_gte.isoformat()

    params["affects__trackers__updated_dt__date__gte"] = json_affects_trackers_updated_dt_date_gte
    ...
    if not isinstance(affects_trackers_updated_dt_date_lte, Unset):
        json_affects_trackers_updated_dt_date_lte = affects_trackers_updated_dt_date_lte.isoformat()

    params["affects__trackers__updated_dt__date__lte"] = json_affects_trackers_updated_dt_date_lte
    ...
    if not isinstance(affects_trackers_updated_dt_gte, Unset):
        json_affects_trackers_updated_dt_gte = affects_trackers_updated_dt_gte.isoformat()
    ...
    if not isinstance(affects_trackers_updated_dt_lte, Unset):
        json_affects_trackers_updated_dt_lte = affects_trackers_updated_dt_lte.isoformat()
    ...
    if not isinstance(cvss_scores_created_dt_date_gte, Unset):
        json_cvss_scores_created_dt_date_gte = cvss_scores_created_dt_date_gte.isoformat()
    ...
    if not isinstance(cvss_scores_created_dt_date_lte, Unset):
        json_cvss_scores_created_dt_date_lte = cvss_scores_created_dt_date_lte.isoformat()
    ...
    if not isinstance(cvss_scores_issuer, Unset):
        json_cvss_scores_issuer = OsidbApiV1FlawsListCvssScoresIssuer(cvss_scores_issuer).value
    ...
    if not isinstance(cvss_scores_updated_dt_date_gte, Unset):
        json_cvss_scores_updated_dt_date_gte = cvss_scores_updated_dt_date_gte.isoformat()
    ...
    if not isinstance(cvss_scores_updated_dt_date_lte, Unset):
        json_cvss_scores_updated_dt_date_lte = cvss_scores_updated_dt_date_lte.isoformat()
    ...
    if not isinstance(major_incident_start_dt_date_gte, Unset):
        json_major_incident_start_dt_date_gte = major_incident_start_dt_date_gte.isoformat()
    ...
    if not isinstance(major_incident_start_dt_date_lte, Unset):
        json_major_incident_start_dt_date_lte = major_incident_start_dt_date_lte.isoformat()
    ...
    if not isinstance(major_incident_state, Unset):
        json_major_incident_state = OsidbApiV1FlawsListMajorIncidentState(major_incident_state).value
    ...
    if not isinstance(nist_cvss_validation, Unset):
        json_nist_cvss_validation = OsidbApiV1FlawsListNistCvssValidation(nist_cvss_validation).value
    ...
    if not isinstance(requires_cve_description, Unset):
        json_requires_cve_description = OsidbApiV1FlawsListRequiresCveDescription(requires_cve_description).value
    ...
    if not isinstance(workflow_state, Unset):
        ...
        for workflow_state_item_data in workflow_state:
            ...
            if not isinstance(workflow_state_item_data, Unset):
                workflow_state_item = OsidbApiV1FlawsListWorkflowStateItem(workflow_state_item_data).value
