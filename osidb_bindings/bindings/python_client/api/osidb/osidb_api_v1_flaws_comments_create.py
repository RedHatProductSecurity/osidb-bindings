...
from ...models.osidb_api_v1_flaws_comments_create_response_201 import OsidbApiV1FlawsCommentsCreateResponse201
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, FlawCommentPost):
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 201:
        ...
        if isinstance(_response_201, Unset):
            ...
            response_201 = OsidbApiV1FlawsCommentsCreateResponse201.from_dict(_response_201)
