...
from ...models.osidb_api_v2_trackers_update_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "url": f"{client.base_url}/osidb/api/v2/trackers/{uuid}".format(
            uuid=uuid,
        ),
    }
...
) -> Optional[OsidbApiV2TrackersUpdateResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: OsidbApiV2TrackersUpdateResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2TrackersUpdateResponse200.from_dict(_response_200)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2TrackersUpdateResponse200]:
    return Response(
