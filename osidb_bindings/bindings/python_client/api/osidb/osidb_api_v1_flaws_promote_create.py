...
from ...models.osidb_api_v1_flaws_promote_create_response_200 import OsidbApiV1FlawsPromoteCreateResponse200
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        if isinstance(_response_200, Unset):
            ...
            response_200 = OsidbApiV1FlawsPromoteCreateResponse200.from_dict(_response_200)
