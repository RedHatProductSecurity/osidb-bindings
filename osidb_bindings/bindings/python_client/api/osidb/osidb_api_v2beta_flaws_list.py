...
from ...models.osidb_api_v2_beta_flaws_list_affects_affectedness import (
    OsidbApiV2BetaFlawsListAffectsAffectedness,
)
from ...models.osidb_api_v2_beta_flaws_list_affects_impact import (
    OsidbApiV2BetaFlawsListAffectsImpact,
)
from ...models.osidb_api_v2_beta_flaws_list_affects_resolution import (
    OsidbApiV2BetaFlawsListAffectsResolution,
)
from ...models.osidb_api_v2_beta_flaws_list_affects_tracker_type import (
    OsidbApiV2BetaFlawsListAffectsTrackerType,
)
from ...models.osidb_api_v2_beta_flaws_list_cvss_scores_issuer import (
    OsidbApiV2BetaFlawsListCvssScoresIssuer,
)
from ...models.osidb_api_v2_beta_flaws_list_impact import OsidbApiV2BetaFlawsListImpact
from ...models.osidb_api_v2_beta_flaws_list_major_incident_state import (
    OsidbApiV2BetaFlawsListMajorIncidentState,
)
from ...models.osidb_api_v2_beta_flaws_list_nist_cvss_validation import (
    OsidbApiV2BetaFlawsListNistCvssValidation,
)
from ...models.osidb_api_v2_beta_flaws_list_order_item import (
    OsidbApiV2BetaFlawsListOrderItem,
)
from ...models.osidb_api_v2_beta_flaws_list_references_type import (
    OsidbApiV2BetaFlawsListReferencesType,
)
from ...models.osidb_api_v2_beta_flaws_list_requires_cve_description import (
    OsidbApiV2BetaFlawsListRequiresCveDescription,
)
from ...models.osidb_api_v2_beta_flaws_list_response_200 import (
    OsidbApiV2BetaFlawsListResponse200,
)
from ...models.osidb_api_v2_beta_flaws_list_source import OsidbApiV2BetaFlawsListSource
from ...models.osidb_api_v2_beta_flaws_list_workflow_state_item import (
...
QUERY_PARAMS = {
    ...
    "affects__affectedness": OsidbApiV2BetaFlawsListAffectsAffectedness,
    ...
    "affects__impact": OsidbApiV2BetaFlawsListAffectsImpact,
    "affects__ps_component": str,
    "affects__ps_module": str,
    "affects__resolution": OsidbApiV2BetaFlawsListAffectsResolution,
    ...
    "affects__tracker__type": OsidbApiV2BetaFlawsListAffectsTrackerType,
    ...
    "cvss_scores__issuer": OsidbApiV2BetaFlawsListCvssScoresIssuer,
    ...
    "impact": OsidbApiV2BetaFlawsListImpact,
    ...
    "major_incident_state": OsidbApiV2BetaFlawsListMajorIncidentState,
    "mitigation__isempty": bool,
    "nist_cvss_validation": OsidbApiV2BetaFlawsListNistCvssValidation,
    "offset": int,
    "order": list[OsidbApiV2BetaFlawsListOrderItem],
    "owner": str,
    "owner__isempty": bool,
    "query": str,
    ...
    "references__type": OsidbApiV2BetaFlawsListReferencesType,
    ...
    "requires_cve_description": OsidbApiV2BetaFlawsListRequiresCveDescription,
    "search": str,
    "source": OsidbApiV2BetaFlawsListSource,
    "statement": str,
    ...
    "uuid": UUID,
    "workflow_state": list[OsidbApiV2BetaFlawsListWorkflowStateItem],
}
...
def _get_kwargs(
    *,
    ...
    affects_affectedness: Union[
        Unset, OsidbApiV2BetaFlawsListAffectsAffectedness
    ] = UNSET,
    ...
    affects_impact: Union[Unset, OsidbApiV2BetaFlawsListAffectsImpact] = UNSET,
    affects_ps_component: Union[Unset, str] = UNSET,
    affects_ps_module: Union[Unset, str] = UNSET,
    affects_resolution: Union[Unset, OsidbApiV2BetaFlawsListAffectsResolution] = UNSET,
    ...
    affects_tracker_type: Union[
        Unset, OsidbApiV2BetaFlawsListAffectsTrackerType
    ] = UNSET,
    ...
    cvss_scores_issuer: Union[Unset, OsidbApiV2BetaFlawsListCvssScoresIssuer] = UNSET,
    ...
    impact: Union[Unset, OsidbApiV2BetaFlawsListImpact] = UNSET,
    ...
    major_incident_state: Union[
        Unset, OsidbApiV2BetaFlawsListMajorIncidentState
    ] = UNSET,
    mitigation_isempty: Union[Unset, bool] = UNSET,
    nist_cvss_validation: Union[
        Unset, OsidbApiV2BetaFlawsListNistCvssValidation
    ] = UNSET,
    offset: Union[Unset, int] = UNSET,
    order: Union[Unset, list[OsidbApiV2BetaFlawsListOrderItem]] = UNSET,
    ...
    references_type: Union[Unset, OsidbApiV2BetaFlawsListReferencesType] = UNSET,
    ...
    requires_cve_description: Union[
        Unset, OsidbApiV2BetaFlawsListRequiresCveDescription
    ] = UNSET,
    search: Union[Unset, str] = UNSET,
    source: Union[Unset, OsidbApiV2BetaFlawsListSource] = UNSET,
    ...
    workflow_state: Union[
        Unset, list[OsidbApiV2BetaFlawsListWorkflowStateItem]
    ] = UNSET,
) -> dict[str, Any]:
    ...
    if not isinstance(affects_affectedness, Unset):
        json_affects_affectedness = OsidbApiV2BetaFlawsListAffectsAffectedness(
    ...
    if not isinstance(affects_impact, Unset):
        json_affects_impact = OsidbApiV2BetaFlawsListAffectsImpact(affects_impact).value
    ...
    if not isinstance(affects_resolution, Unset):
        json_affects_resolution = OsidbApiV2BetaFlawsListAffectsResolution(
            affects_resolution
        ).value
    ...
    if not isinstance(affects_tracker_type, Unset):
        json_affects_tracker_type = OsidbApiV2BetaFlawsListAffectsTrackerType(
    ...
    if not isinstance(cvss_scores_issuer, Unset):
        json_cvss_scores_issuer = OsidbApiV2BetaFlawsListCvssScoresIssuer(
            cvss_scores_issuer
        ).value
    ...
    if not isinstance(impact, Unset):
        json_impact = OsidbApiV2BetaFlawsListImpact(impact).value
    ...
    if not isinstance(major_incident_state, Unset):
        json_major_incident_state = OsidbApiV2BetaFlawsListMajorIncidentState(
    ...
    if not isinstance(nist_cvss_validation, Unset):
        json_nist_cvss_validation = OsidbApiV2BetaFlawsListNistCvssValidation(
    ...
    if not isinstance(order, Unset):
        ...
        for order_item_data in order:
            ...
            if not isinstance(order_item_data, Unset):
                order_item = OsidbApiV2BetaFlawsListOrderItem(order_item_data).value
    ...
    if not isinstance(references_type, Unset):
        json_references_type = OsidbApiV2BetaFlawsListReferencesType(
            references_type
        ).value
    ...
    if not isinstance(requires_cve_description, Unset):
        json_requires_cve_description = OsidbApiV2BetaFlawsListRequiresCveDescription(
    ...
    if not isinstance(source, Unset):
        json_source = OsidbApiV2BetaFlawsListSource(source).value
    ...
    if not isinstance(workflow_state, Unset):
        ...
        for workflow_state_item_data in workflow_state:
            ...
            if not isinstance(workflow_state_item_data, Unset):
                workflow_state_item = OsidbApiV2BetaFlawsListWorkflowStateItem(
    ...
    _kwargs: dict[str, Any] = {
        "url": f"{client.base_url}/osidb/api/v2beta/flaws",
        "params": params,
    }
...
) -> Optional[OsidbApiV2BetaFlawsListResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: OsidbApiV2BetaFlawsListResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2BetaFlawsListResponse200.from_dict(_response_200)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2BetaFlawsListResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        affects_affectedness (Union[Unset, OsidbApiV2BetaFlawsListAffectsAffectedness]):
        ...
        affects_impact (Union[Unset, OsidbApiV2BetaFlawsListAffectsImpact]):
        affects_ps_component (Union[Unset, str]):
        affects_ps_module (Union[Unset, str]):
        affects_resolution (Union[Unset, OsidbApiV2BetaFlawsListAffectsResolution]):
        ...
        affects_tracker_type (Union[Unset, OsidbApiV2BetaFlawsListAffectsTrackerType]):
        ...
        cvss_scores_issuer (Union[Unset, OsidbApiV2BetaFlawsListCvssScoresIssuer]):
        ...
        impact (Union[Unset, OsidbApiV2BetaFlawsListImpact]):
        ...
        major_incident_state (Union[Unset, OsidbApiV2BetaFlawsListMajorIncidentState]):
        mitigation_isempty (Union[Unset, bool]):
        nist_cvss_validation (Union[Unset, OsidbApiV2BetaFlawsListNistCvssValidation]):
        offset (Union[Unset, int]):
        order (Union[Unset, list[OsidbApiV2BetaFlawsListOrderItem]]):
        ...
        references_type (Union[Unset, OsidbApiV2BetaFlawsListReferencesType]):
        ...
        requires_cve_description (Union[Unset, OsidbApiV2BetaFlawsListRequiresCveDescription]):
        search (Union[Unset, str]):
        source (Union[Unset, OsidbApiV2BetaFlawsListSource]):
        ...
        workflow_state (Union[Unset, list[OsidbApiV2BetaFlawsListWorkflowStateItem]]):
