...
from ...models.flaw_reference_put_request import FlawReferencePutRequest
...
REQUEST_BODY_TYPE = FlawReferencePutRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if check_nested_instance(body, FlawReferencePutRequest):
