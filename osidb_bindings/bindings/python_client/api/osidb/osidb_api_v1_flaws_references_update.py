...
from ...models.osidb_api_v1_flaws_references_update_response_200 import OsidbApiV1FlawsReferencesUpdateResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, FlawReferencePut):
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        if isinstance(_response_200, Unset):
            ...
            response_200 = OsidbApiV1FlawsReferencesUpdateResponse200.from_dict(_response_200)
