...
def _get_kwargs(
    ...
    *,
    ...
    form_data: FlawPackageVersionPost,
    multipart_data: FlawPackageVersionPost,
    json_body: FlawPackageVersionPost,
) -> Dict[str, Any]:
    url = "{}/osidb/api/v1/flaws/{flaw_id}/package_versions".format(
        client.base_url,
        flaw_id=flaw_id,
    )
