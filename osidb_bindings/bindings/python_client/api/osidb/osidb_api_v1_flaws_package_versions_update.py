...
from ...models.flaw_package_version_put_request import FlawPackageVersionPutRequest
...
REQUEST_BODY_TYPE = FlawPackageVersionPutRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if check_nested_instance(body, FlawPackageVersionPutRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (FlawPackageVersionPutRequest): Package model serializer
        body (FlawPackageVersionPutRequest): Package model serializer
        body (FlawPackageVersionPutRequest): Package model serializer
