...
from ...models.osidb_api_v1_flaws_references_list_type import OsidbApiV1FlawsReferencesListType
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        if isinstance(_response_200, Unset):
            ...
            response_200 = OsidbApiV1FlawsReferencesListResponse200.from_dict(_response_200)
