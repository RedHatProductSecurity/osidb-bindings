...
from ...models.osidb_api_v1_flaws_cvss_scores_create_response_201 import OsidbApiV1FlawsCvssScoresCreateResponse201
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, FlawCVSSPost):
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 201:
        ...
        if isinstance(_response_201, Unset):
            ...
            response_201 = OsidbApiV1FlawsCvssScoresCreateResponse201.from_dict(_response_201)
