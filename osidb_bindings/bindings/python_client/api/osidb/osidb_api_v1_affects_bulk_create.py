...
from ...models.osidb_api_v1_affects_bulk_create_response_200 import OsidbApiV1AffectsBulkCreateResponse200
...
def _get_kwargs(
    *,
    ...
    if isinstance(body, list["AffectPost"]):
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        if isinstance(_response_200, Unset):
            ...
            response_200 = OsidbApiV1AffectsBulkCreateResponse200.from_dict(_response_200)
