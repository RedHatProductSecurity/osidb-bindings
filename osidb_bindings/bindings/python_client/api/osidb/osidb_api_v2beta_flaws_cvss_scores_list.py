...
from ...models.osidb_api_v2_beta_flaws_cvss_scores_list_issuer import (
    OsidbApiV2BetaFlawsCvssScoresListIssuer,
)
from ...models.osidb_api_v2_beta_flaws_cvss_scores_list_response_200 import (
...
QUERY_PARAMS = {
    ...
    "issuer": OsidbApiV2BetaFlawsCvssScoresListIssuer,
    "limit": int,
    "offset": int,
    "score": float,
...
def _get_kwargs(
    ...
    *,
    ...
    issuer: Union[Unset, OsidbApiV2BetaFlawsCvssScoresListIssuer] = UNSET,
    ...
    if not isinstance(issuer, Unset):
        json_issuer = OsidbApiV2BetaFlawsCvssScoresListIssuer(issuer).value
    ...
    _kwargs: dict[str, Any] = {
        "url": f"{client.base_url}/osidb/api/v2beta/flaws/{flaw_id}/cvss-scores".format(
            flaw_id=flaw_id,
        ),
        "params": params,
    }
...
) -> Optional[OsidbApiV2BetaFlawsCvssScoresListResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: OsidbApiV2BetaFlawsCvssScoresListResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2BetaFlawsCvssScoresListResponse200.from_dict(
                _response_200
            )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2BetaFlawsCvssScoresListResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        issuer (Union[Unset, OsidbApiV2BetaFlawsCvssScoresListIssuer]):
