...
from ...models.osidb_api_v2_trackers_create_response_201 import (
...
) -> Optional[OsidbApiV2TrackersCreateResponse201]:
    if response.status_code == 201:
        _response_201 = response.json()
        response_201: OsidbApiV2TrackersCreateResponse201
        if isinstance(_response_201, Unset):
            response_201 = UNSET
        else:
            response_201 = OsidbApiV2TrackersCreateResponse201.from_dict(_response_201)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2TrackersCreateResponse201]:
    return Response(
