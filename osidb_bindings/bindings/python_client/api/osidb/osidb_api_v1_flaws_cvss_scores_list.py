...
from ...models.osidb_api_v1_flaws_cvss_scores_list_issuer import OsidbApiV1FlawsCvssScoresListIssuer
from ...models.osidb_api_v1_flaws_cvss_scores_list_response_200 import OsidbApiV1FlawsCvssScoresListResponse200
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        if isinstance(_response_200, Unset):
            ...
            response_200 = OsidbApiV1FlawsCvssScoresListResponse200.from_dict(_response_200)
