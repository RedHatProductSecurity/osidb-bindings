...
from ...models.osidb_api_v1_flaws_cvss_scores_list_issuer_in_item import (
...
QUERY_PARAMS = {
    ...
    "issuer__in": list[OsidbApiV1FlawsCvssScoresListIssuerInItem],
    "limit": int,
    "offset": int,
    "score": float,
...
def _get_kwargs(
    ...
    *,
    ...
    issuer_in: Union[Unset, list[OsidbApiV1FlawsCvssScoresListIssuerInItem]] = UNSET,
    ...
    if not isinstance(issuer_in, Unset):
        ...
        for issuer_in_item_data in issuer_in:
            ...
            if not isinstance(issuer_in_item_data, Unset):
                issuer_in_item = OsidbApiV1FlawsCvssScoresListIssuerInItem(
                    issuer_in_item_data
                ).value
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        issuer_in (Union[Unset, list[OsidbApiV1FlawsCvssScoresListIssuerInItem]]):
