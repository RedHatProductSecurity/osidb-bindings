...
from ...models.osidb_api_v1_trackers_create_response_201 import OsidbApiV1TrackersCreateResponse201
...
def _parse_response(*, response: requests.Response) -> Optional[OsidbApiV1TrackersCreateResponse201]:
...
def _build_response(*, response: requests.Response) -> Response[OsidbApiV1TrackersCreateResponse201]:
    return Response(
