...
from ...models.osidb_api_v1_flaws_cvss_scores_retrieve_response_200 import OsidbApiV1FlawsCvssScoresRetrieveResponse200
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        if isinstance(_response_200, Unset):
            ...
            response_200 = OsidbApiV1FlawsCvssScoresRetrieveResponse200.from_dict(_response_200)
