...
from ...models.osidb_api_v1_trackers_list_affects_affectedness import OsidbApiV1TrackersListAffectsAffectedness
from ...models.osidb_api_v1_trackers_list_affects_flaw_impact import OsidbApiV1TrackersListAffectsFlawImpact
from ...models.osidb_api_v1_trackers_list_affects_flaw_source import OsidbApiV1TrackersListAffectsFlawSource
from ...models.osidb_api_v1_trackers_list_affects_impact import OsidbApiV1TrackersListAffectsImpact
from ...models.osidb_api_v1_trackers_list_affects_resolution import OsidbApiV1TrackersListAffectsResolution
from ...models.osidb_api_v1_trackers_list_order_item import OsidbApiV1TrackersListOrderItem
...
def _get_kwargs(
    *,
    ...
    affects_affectedness: Union[Unset, OsidbApiV1TrackersListAffectsAffectedness] = UNSET,
    ...
    if not isinstance(affects_affectedness, Unset):
        json_affects_affectedness = OsidbApiV1TrackersListAffectsAffectedness(affects_affectedness).value
    ...
    if not isinstance(affects_flaw_created_dt_date_gte, Unset):
        json_affects_flaw_created_dt_date_gte = affects_flaw_created_dt_date_gte.isoformat()

    params["affects__flaw__created_dt__date__gte"] = json_affects_flaw_created_dt_date_gte

    json_affects_flaw_created_dt_date_lte: Union[Unset, str] = UNSET
    if not isinstance(affects_flaw_created_dt_date_lte, Unset):
        json_affects_flaw_created_dt_date_lte = affects_flaw_created_dt_date_lte.isoformat()

    params["affects__flaw__created_dt__date__lte"] = json_affects_flaw_created_dt_date_lte
    ...
    if not isinstance(affects_flaw_impact, Unset):
        json_affects_flaw_impact = OsidbApiV1TrackersListAffectsFlawImpact(affects_flaw_impact).value
    ...
    if not isinstance(affects_flaw_reported_dt_date_gte, Unset):
        json_affects_flaw_reported_dt_date_gte = affects_flaw_reported_dt_date_gte.isoformat()

    params["affects__flaw__reported_dt__date__gte"] = json_affects_flaw_reported_dt_date_gte

    json_affects_flaw_reported_dt_date_lte: Union[Unset, str] = UNSET
    if not isinstance(affects_flaw_reported_dt_date_lte, Unset):
        json_affects_flaw_reported_dt_date_lte = affects_flaw_reported_dt_date_lte.isoformat()

    params["affects__flaw__reported_dt__date__lte"] = json_affects_flaw_reported_dt_date_lte
    ...
    if not isinstance(affects_flaw_source, Unset):
        json_affects_flaw_source = OsidbApiV1TrackersListAffectsFlawSource(affects_flaw_source).value
    ...
    if not isinstance(affects_flaw_updated_dt_date_gte, Unset):
        json_affects_flaw_updated_dt_date_gte = affects_flaw_updated_dt_date_gte.isoformat()

    params["affects__flaw__updated_dt__date__gte"] = json_affects_flaw_updated_dt_date_gte

    json_affects_flaw_updated_dt_date_lte: Union[Unset, str] = UNSET
    if not isinstance(affects_flaw_updated_dt_date_lte, Unset):
        json_affects_flaw_updated_dt_date_lte = affects_flaw_updated_dt_date_lte.isoformat()

    params["affects__flaw__updated_dt__date__lte"] = json_affects_flaw_updated_dt_date_lte
    ...
    if not isinstance(affects_resolution, Unset):
        json_affects_resolution = OsidbApiV1TrackersListAffectsResolution(affects_resolution).value
