...
from ...models.osidb_api_v1_flaws_labels_retrieve_response_200 import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        response_200: OsidbApiV1FlawsLabelsRetrieveResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV1FlawsLabelsRetrieveResponse200.from_dict(
                _response_200
            )
