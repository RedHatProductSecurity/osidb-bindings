...
from ...models.affect_cvss_put_request import AffectCVSSPutRequest
...
REQUEST_BODY_TYPE = AffectCVSSPutRequest
...
def _get_kwargs(
    ...
    *,
    ...
    if check_nested_instance(body, AffectCVSSPutRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (AffectCVSSPutRequest): AffectCVSS serializer
        body (AffectCVSSPutRequest): AffectCVSS serializer
        body (AffectCVSSPutRequest): AffectCVSS serializer
