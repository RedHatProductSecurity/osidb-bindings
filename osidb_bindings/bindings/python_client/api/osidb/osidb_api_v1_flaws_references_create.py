...
from ...models.osidb_api_v1_flaws_references_create_response_201 import OsidbApiV1FlawsReferencesCreateResponse201
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 201:
        ...
        if isinstance(_response_201, Unset):
            ...
            response_201 = OsidbApiV1FlawsReferencesCreateResponse201.from_dict(_response_201)
