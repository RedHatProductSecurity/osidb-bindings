...
from ...models.osidb_api_v2_trackers_retrieve_response_200 import (
...
) -> Optional[OsidbApiV2TrackersRetrieveResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: OsidbApiV2TrackersRetrieveResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2TrackersRetrieveResponse200.from_dict(
                _response_200
            )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2TrackersRetrieveResponse200]:
    return Response(
