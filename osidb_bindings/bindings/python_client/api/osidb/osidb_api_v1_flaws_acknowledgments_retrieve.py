...
from ...models.osidb_api_v1_flaws_acknowledgments_retrieve_response_200 import (
...
) -> Optional[OsidbApiV1FlawsAcknowledgmentsRetrieveResponse200]:
    if response.status_code == 200:
        # }
        _response_200 = response.json()
        response_200: OsidbApiV1FlawsAcknowledgmentsRetrieveResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV1FlawsAcknowledgmentsRetrieveResponse200.from_dict(_response_200)
