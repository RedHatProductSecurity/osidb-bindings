...
from ...models.osidb_api_v2_beta_affects_list_affectedness import (
    OsidbApiV2BetaAffectsListAffectedness,
)
from ...models.osidb_api_v2_beta_affects_list_cvss_scores_issuer import (
    OsidbApiV2BetaAffectsListCvssScoresIssuer,
)
from ...models.osidb_api_v2_beta_affects_list_flaw_impact import (
    OsidbApiV2BetaAffectsListFlawImpact,
)
from ...models.osidb_api_v2_beta_affects_list_flaw_source import (
    OsidbApiV2BetaAffectsListFlawSource,
)
from ...models.osidb_api_v2_beta_affects_list_flaw_workflow_state_item import (
    OsidbApiV2BetaAffectsListFlawWorkflowStateItem,
)
from ...models.osidb_api_v2_beta_affects_list_impact import (
    OsidbApiV2BetaAffectsListImpact,
)
from ...models.osidb_api_v2_beta_affects_list_order_item import (
    OsidbApiV2BetaAffectsListOrderItem,
)
from ...models.osidb_api_v2_beta_affects_list_resolution import (
    OsidbApiV2BetaAffectsListResolution,
)
from ...models.osidb_api_v2_beta_affects_list_response_200 import (
    OsidbApiV2BetaAffectsListResponse200,
)
from ...models.osidb_api_v2_beta_affects_list_tracker_type import (
    OsidbApiV2BetaAffectsListTrackerType,
)
from ...types import UNSET, Response, Unset

QUERY_PARAMS = {
    "affectedness": OsidbApiV2BetaAffectsListAffectedness,
    ...
    "cvss_scores__issuer": OsidbApiV2BetaAffectsListCvssScoresIssuer,
    ...
    "flaw__impact": OsidbApiV2BetaAffectsListFlawImpact,
    ...
    "flaw__source": OsidbApiV2BetaAffectsListFlawSource,
    ...
    "flaw__uuid": UUID,
    "flaw__workflow_state": list[OsidbApiV2BetaAffectsListFlawWorkflowStateItem],
    "impact": OsidbApiV2BetaAffectsListImpact,
    "include_fields": list[str],
    "include_history": bool,
    "include_meta_attr": list[str],
    "limit": int,
    "offset": int,
    "order": list[OsidbApiV2BetaAffectsListOrderItem],
    "ps_component": str,
    "ps_module": str,
    "ps_update_stream": str,
    "resolution": OsidbApiV2BetaAffectsListResolution,
    ...
    "tracker__status": str,
    "tracker__type": OsidbApiV2BetaAffectsListTrackerType,
...
def _get_kwargs(
    *,
    ...
    affectedness: Union[Unset, OsidbApiV2BetaAffectsListAffectedness] = UNSET,
    ...
    cvss_scores_issuer: Union[Unset, OsidbApiV2BetaAffectsListCvssScoresIssuer] = UNSET,
    ...
    flaw_impact: Union[Unset, OsidbApiV2BetaAffectsListFlawImpact] = UNSET,
    ...
    flaw_source: Union[Unset, OsidbApiV2BetaAffectsListFlawSource] = UNSET,
    ...
    flaw_workflow_state: Union[
        Unset, list[OsidbApiV2BetaAffectsListFlawWorkflowStateItem]
    ] = UNSET,
    impact: Union[Unset, OsidbApiV2BetaAffectsListImpact] = UNSET,
    ...
    order: Union[Unset, list[OsidbApiV2BetaAffectsListOrderItem]] = UNSET,
    ps_component: Union[Unset, str] = UNSET,
    ps_module: Union[Unset, str] = UNSET,
    ps_update_stream: Union[Unset, str] = UNSET,
    resolution: Union[Unset, OsidbApiV2BetaAffectsListResolution] = UNSET,
    ...
    tracker_type: Union[Unset, OsidbApiV2BetaAffectsListTrackerType] = UNSET,
    ...
    if not isinstance(affectedness, Unset):
        json_affectedness = OsidbApiV2BetaAffectsListAffectedness(affectedness).value
    ...
    if not isinstance(cvss_scores_issuer, Unset):
        json_cvss_scores_issuer = OsidbApiV2BetaAffectsListCvssScoresIssuer(
            cvss_scores_issuer
        ).value
    ...
    if not isinstance(flaw_impact, Unset):
        json_flaw_impact = OsidbApiV2BetaAffectsListFlawImpact(flaw_impact).value
    ...
    if not isinstance(flaw_source, Unset):
        json_flaw_source = OsidbApiV2BetaAffectsListFlawSource(flaw_source).value
    ...
    if not isinstance(impact, Unset):
        json_impact = OsidbApiV2BetaAffectsListImpact(impact).value
    ...
    if not isinstance(order, Unset):
        ...
        for order_item_data in order:
            ...
            if not isinstance(order_item_data, Unset):
                order_item = OsidbApiV2BetaAffectsListOrderItem(order_item_data).value
    ...
    if not isinstance(resolution, Unset):
        json_resolution = OsidbApiV2BetaAffectsListResolution(resolution).value
    ...
    if not isinstance(tracker_type, Unset):
        json_tracker_type = OsidbApiV2BetaAffectsListTrackerType(tracker_type).value
    ...
    _kwargs: dict[str, Any] = {
        "url": f"{client.base_url}/osidb/api/v2beta/affects",
        "params": params,
    }
...
) -> Optional[OsidbApiV2BetaAffectsListResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: OsidbApiV2BetaAffectsListResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2BetaAffectsListResponse200.from_dict(_response_200)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2BetaAffectsListResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """
    Args:
        affectedness (Union[Unset, OsidbApiV2BetaAffectsListAffectedness]):
        ...
        cvss_scores_issuer (Union[Unset, OsidbApiV2BetaAffectsListCvssScoresIssuer]):
        ...
        flaw_impact (Union[Unset, OsidbApiV2BetaAffectsListFlawImpact]):
        ...
        flaw_source (Union[Unset, OsidbApiV2BetaAffectsListFlawSource]):
        ...
        flaw_workflow_state (Union[Unset, list[OsidbApiV2BetaAffectsListFlawWorkflowStateItem]]):
        impact (Union[Unset, OsidbApiV2BetaAffectsListImpact]):
        include_fields (Union[Unset, list[str]]):
        include_history (Union[Unset, bool]):
        include_meta_attr (Union[Unset, list[str]]):
        limit (Union[Unset, int]):
        offset (Union[Unset, int]):
        order (Union[Unset, list[OsidbApiV2BetaAffectsListOrderItem]]):
        ps_component (Union[Unset, str]):
        ps_module (Union[Unset, str]):
        ps_update_stream (Union[Unset, str]):
        resolution (Union[Unset, OsidbApiV2BetaAffectsListResolution]):
        ...
        tracker_type (Union[Unset, OsidbApiV2BetaAffectsListTrackerType]):
