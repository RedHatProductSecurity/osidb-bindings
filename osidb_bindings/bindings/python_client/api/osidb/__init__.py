...
ENDPOINT_NAMES = [
    ...
    "osidb_api_v1_affects_cvss_scores_destroy",
    "osidb_api_v1_affects_retrieve",
    "osidb_api_v1_affects_update",
    "osidb_api_v1_affects_destroy",
    "osidb_api_v1_affects_bulk_update",
    "osidb_api_v1_affects_bulk_create",
    "osidb_api_v1_affects_bulk_destroy",
