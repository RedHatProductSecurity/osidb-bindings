...
from ...models.osidb_api_v2_beta_affects_cvss_scores_retrieve_response_200 import (
...
) -> Optional[OsidbApiV2BetaAffectsCvssScoresRetrieveResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: OsidbApiV2BetaAffectsCvssScoresRetrieveResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2BetaAffectsCvssScoresRetrieveResponse200.from_dict(
                _response_200
            )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2BetaAffectsCvssScoresRetrieveResponse200]:
    return Response(
