...
from ...models.osidb_api_v2_beta_trackers_list_affects_affectedness import (
    OsidbApiV2BetaTrackersListAffectsAffectedness,
)
from ...models.osidb_api_v2_beta_trackers_list_affects_flaw_impact import (
    OsidbApiV2BetaTrackersListAffectsFlawImpact,
)
from ...models.osidb_api_v2_beta_trackers_list_affects_flaw_source import (
    OsidbApiV2BetaTrackersListAffectsFlawSource,
)
from ...models.osidb_api_v2_beta_trackers_list_affects_impact import (
    OsidbApiV2BetaTrackersListAffectsImpact,
)
from ...models.osidb_api_v2_beta_trackers_list_affects_resolution import (
    OsidbApiV2BetaTrackersListAffectsResolution,
)
from ...models.osidb_api_v2_beta_trackers_list_order_item import (
    OsidbApiV2BetaTrackersListOrderItem,
)
from ...models.osidb_api_v2_beta_trackers_list_response_200 import (
    OsidbApiV2BetaTrackersListResponse200,
)
from ...models.osidb_api_v2_beta_trackers_list_type import (
    OsidbApiV2BetaTrackersListType,
)
from ...types import UNSET, Response, Unset

QUERY_PARAMS = {
    "affects__affectedness": OsidbApiV2BetaTrackersListAffectsAffectedness,
    ...
    "affects__flaw__impact": OsidbApiV2BetaTrackersListAffectsFlawImpact,
    ...
    "affects__flaw__source": OsidbApiV2BetaTrackersListAffectsFlawSource,
    ...
    "affects__impact": OsidbApiV2BetaTrackersListAffectsImpact,
    "affects__ps_component": str,
    "affects__ps_module": str,
    "affects__resolution": OsidbApiV2BetaTrackersListAffectsResolution,
    ...
    "limit": int,
    "offset": int,
    "order": list[OsidbApiV2BetaTrackersListOrderItem],
    "ps_update_stream": str,
    "resolution": str,
    "status": str,
    "type": OsidbApiV2BetaTrackersListType,
...
def _get_kwargs(
    *,
    ...
    affects_affectedness: Union[
        Unset, OsidbApiV2BetaTrackersListAffectsAffectedness
    ] = UNSET,
    ...
    affects_flaw_impact: Union[
        Unset, OsidbApiV2BetaTrackersListAffectsFlawImpact
    ] = UNSET,
    ...
    affects_flaw_source: Union[
        Unset, OsidbApiV2BetaTrackersListAffectsFlawSource
    ] = UNSET,
    ...
    affects_impact: Union[Unset, OsidbApiV2BetaTrackersListAffectsImpact] = UNSET,
    affects_ps_component: Union[Unset, str] = UNSET,
    affects_ps_module: Union[Unset, str] = UNSET,
    affects_resolution: Union[
        Unset, OsidbApiV2BetaTrackersListAffectsResolution
    ] = UNSET,
    ...
    order: Union[Unset, list[OsidbApiV2BetaTrackersListOrderItem]] = UNSET,
    ps_update_stream: Union[Unset, str] = UNSET,
    resolution: Union[Unset, str] = UNSET,
    status: Union[Unset, str] = UNSET,
    type_: Union[Unset, OsidbApiV2BetaTrackersListType] = UNSET,
    ...
    if not isinstance(affects_affectedness, Unset):
        json_affects_affectedness = OsidbApiV2BetaTrackersListAffectsAffectedness(
    ...
    if not isinstance(affects_flaw_impact, Unset):
        json_affects_flaw_impact = OsidbApiV2BetaTrackersListAffectsFlawImpact(
            affects_flaw_impact
        ).value
    ...
    if not isinstance(affects_flaw_source, Unset):
        json_affects_flaw_source = OsidbApiV2BetaTrackersListAffectsFlawSource(
            affects_flaw_source
        ).value
    ...
    if not isinstance(affects_impact, Unset):
        json_affects_impact = OsidbApiV2BetaTrackersListAffectsImpact(
            affects_impact
        ).value
    ...
    if not isinstance(affects_resolution, Unset):
        json_affects_resolution = OsidbApiV2BetaTrackersListAffectsResolution(
            affects_resolution
        ).value
    ...
    if not isinstance(order, Unset):
        ...
        for order_item_data in order:
            ...
            if not isinstance(order_item_data, Unset):
                order_item = OsidbApiV2BetaTrackersListOrderItem(order_item_data).value
    ...
    if not isinstance(type_, Unset):
        json_type_ = OsidbApiV2BetaTrackersListType(type_).value
    ...
    _kwargs: dict[str, Any] = {
        "url": f"{client.base_url}/osidb/api/v2beta/trackers",
        "params": params,
    }
...
) -> Optional[OsidbApiV2BetaTrackersListResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: OsidbApiV2BetaTrackersListResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2BetaTrackersListResponse200.from_dict(
                _response_200
            )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2BetaTrackersListResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """
    Args:
        affects_affectedness (Union[Unset, OsidbApiV2BetaTrackersListAffectsAffectedness]):
        ...
        affects_flaw_impact (Union[Unset, OsidbApiV2BetaTrackersListAffectsFlawImpact]):
        ...
        affects_flaw_source (Union[Unset, OsidbApiV2BetaTrackersListAffectsFlawSource]):
        ...
        affects_impact (Union[Unset, OsidbApiV2BetaTrackersListAffectsImpact]):
        affects_ps_component (Union[Unset, str]):
        affects_ps_module (Union[Unset, str]):
        affects_resolution (Union[Unset, OsidbApiV2BetaTrackersListAffectsResolution]):
        ...
        order (Union[Unset, list[OsidbApiV2BetaTrackersListOrderItem]]):
        ps_update_stream (Union[Unset, str]):
        resolution (Union[Unset, str]):
        status (Union[Unset, str]):
        type_ (Union[Unset, OsidbApiV2BetaTrackersListType]):
