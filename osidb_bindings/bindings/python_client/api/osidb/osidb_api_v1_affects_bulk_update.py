...
from ...models.osidb_api_v1_affects_bulk_update_response_200 import OsidbApiV1AffectsBulkUpdateResponse200
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        if isinstance(_response_200, Unset):
            ...
            response_200 = OsidbApiV1AffectsBulkUpdateResponse200.from_dict(_response_200)
