...
from ...models.osidb_api_v1_flaws_comments_retrieve_response_200 import OsidbApiV1FlawsCommentsRetrieveResponse200
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        if isinstance(_response_200, Unset):
            ...
            response_200 = OsidbApiV1FlawsCommentsRetrieveResponse200.from_dict(_response_200)
