...
from ...models.osidb_api_v2_beta_affects_cvss_scores_list_issuer import (
    OsidbApiV2BetaAffectsCvssScoresListIssuer,
)
from ...models.osidb_api_v2_beta_affects_cvss_scores_list_response_200 import (
...
QUERY_PARAMS = {
    ...
    "issuer": OsidbApiV2BetaAffectsCvssScoresListIssuer,
    "limit": int,
    "offset": int,
    "score": float,
...
def _get_kwargs(
    ...
    *,
    ...
    issuer: Union[Unset, OsidbApiV2BetaAffectsCvssScoresListIssuer] = UNSET,
    ...
    if not isinstance(issuer, Unset):
        json_issuer = OsidbApiV2BetaAffectsCvssScoresListIssuer(issuer).value
...
) -> Optional[OsidbApiV2BetaAffectsCvssScoresListResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: OsidbApiV2BetaAffectsCvssScoresListResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2BetaAffectsCvssScoresListResponse200.from_dict(
                _response_200
            )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2BetaAffectsCvssScoresListResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        issuer (Union[Unset, OsidbApiV2BetaAffectsCvssScoresListIssuer]):
