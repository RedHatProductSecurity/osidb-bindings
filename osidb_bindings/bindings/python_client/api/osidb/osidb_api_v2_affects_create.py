...
from ...models.osidb_api_v2_affects_create_response_201 import (
...
) -> Optional[OsidbApiV2AffectsCreateResponse201]:
    if response.status_code == 201:
        _response_201 = response.json()
        response_201: OsidbApiV2AffectsCreateResponse201
        if isinstance(_response_201, Unset):
            response_201 = UNSET
        else:
            response_201 = OsidbApiV2AffectsCreateResponse201.from_dict(_response_201)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2AffectsCreateResponse201]:
    return Response(
