...
def _parse_response(*, response: requests.Response) -> Optional[OsidbApiV1StatusRetrieveResponse200]:
...
def _build_response(*, response: requests.Response) -> Response[OsidbApiV1StatusRetrieveResponse200]:
    return Response(
