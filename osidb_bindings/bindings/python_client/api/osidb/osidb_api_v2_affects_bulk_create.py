...
from ...models.osidb_api_v2_affects_bulk_create_response_200 import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        response_200: OsidbApiV2AffectsBulkCreateResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2AffectsBulkCreateResponse200.from_dict(
                _response_200
            )
