...
from ...models.osidb_api_v2_beta_trackers_retrieve_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "url": f"{client.base_url}/osidb/api/v2beta/trackers/{uuid}".format(
            uuid=uuid,
        ),
        "params": params,
    }
...
) -> Optional[OsidbApiV2BetaTrackersRetrieveResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: OsidbApiV2BetaTrackersRetrieveResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2BetaTrackersRetrieveResponse200.from_dict(
                _response_200
            )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[OsidbApiV2BetaTrackersRetrieveResponse200]:
    return Response(
