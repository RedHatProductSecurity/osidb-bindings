...
from ...models.osidb_api_v1_affects_bulk_destroy_response_200 import OsidbApiV1AffectsBulkDestroyResponse200
    ...
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        if isinstance(_response_200, Unset):
            ...
            response_200 = OsidbApiV1AffectsBulkDestroyResponse200.from_dict(_response_200)
