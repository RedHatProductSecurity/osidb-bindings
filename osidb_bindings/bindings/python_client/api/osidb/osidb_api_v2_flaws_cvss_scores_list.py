...
def _get_kwargs(
    ...
    *,
    ...
    if not isinstance(issuer, Unset):
        json_issuer = OsidbApiV2FlawsCvssScoresListIssuer(issuer).value
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
    ...
    if response.status_code == 200:
        ...
        response_200: OsidbApiV2FlawsCvssScoresListResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = OsidbApiV2FlawsCvssScoresListResponse200.from_dict(
                _response_200
            )
