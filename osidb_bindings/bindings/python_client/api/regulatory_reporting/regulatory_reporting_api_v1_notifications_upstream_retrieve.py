...
from ...models.regulatory_reporting_api_v1_notifications_upstream_retrieve_response_200 import (
...
) -> Optional[RegulatoryReportingApiV1NotificationsUpstreamRetrieveResponse200]:
    if response.status_code == 200:
        _response_200 = response.json()
        response_200: RegulatoryReportingApiV1NotificationsUpstreamRetrieveResponse200
        if isinstance(_response_200, Unset):
            response_200 = UNSET
        else:
            response_200 = RegulatoryReportingApiV1NotificationsUpstreamRetrieveResponse200.from_dict(
                _response_200
            )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: requests.Response
) -> Response[RegulatoryReportingApiV1NotificationsUpstreamRetrieveResponse200]:
    return Response(
