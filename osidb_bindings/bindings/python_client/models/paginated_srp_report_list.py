...
T = TypeVar("T", bound="PaginatedSRPReportList")


@_attrs_define
class PaginatedSRPReportList(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        paginated_srp_report_list.additional_properties = d
        return paginated_srp_report_list
