...
class Flaw(OSIDBModel):
    ...
    requires_cve_description: Union[BlankEnum, RequiresCveDescriptionEnum, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.requires_cve_description, Unset):
            ...
            if not isinstance(self.requires_cve_description, Unset):
                requires_cve_description = RequiresCveDescriptionEnum(self.requires_cve_description).value

        else:
            requires_cve_description = UNSET
            if not isinstance(self.requires_cve_description, Unset):
                requires_cve_description = BlankEnum(self.requires_cve_description).value
        ...
        if isinstance(self.major_incident_state, Unset):
            ...
            if not isinstance(self.major_incident_state, Unset):
                major_incident_state = MajorIncidentStateEnum(self.major_incident_state).value
        ...
        if isinstance(self.nist_cvss_validation, Unset):
            ...
            if not isinstance(self.nist_cvss_validation, Unset):
                nist_cvss_validation = NistCvssValidationEnum(self.nist_cvss_validation).value
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        if not isinstance(self.package_versions, Unset):
            ...
            package_versions = (None, json.dumps(_temp_package_versions).encode(), "application/json")
        ...
        if not isinstance(self.acknowledgments, Unset):
            ...
            acknowledgments = (None, json.dumps(_temp_acknowledgments).encode(), "application/json")
        ...
        if not isinstance(self.references, Unset):
            ...
            references = (None, json.dumps(_temp_references).encode(), "application/json")
        ...
        if not isinstance(self.cvss_scores, Unset):
            ...
            cvss_scores = (None, json.dumps(_temp_cvss_scores).encode(), "application/json")
        ...
        if not isinstance(self.classification, Unset):
            classification = (None, json.dumps(self.classification.to_dict()).encode(), "application/json")
        ...
        if not isinstance(self.components, Unset):
            ...
            components = (None, json.dumps(_temp_components).encode(), "application/json")
        ...
        if isinstance(self.requires_cve_description, Unset):
            ...
            if not isinstance(self.requires_cve_description, Unset):
                requires_cve_description = (None, str(self.requires_cve_description.value).encode(), "text/plain")
            # CHANGE END (3) #}
        else:
            requires_cve_description: Union[Unset, tuple[None, bytes, str]] = UNSET
            if not isinstance(self.requires_cve_description, Unset):
        ...
        statement = (
            self.statement if isinstance(self.statement, Unset) else (None, str(self.statement).encode(), "text/plain")
        )

        cwe_id = self.cwe_id if isinstance(self.cwe_id, Unset) else (None, str(self.cwe_id).encode(), "text/plain")
        ...
        if isinstance(self.major_incident_state, Unset):
            ...
            if not isinstance(self.major_incident_state, Unset):
                major_incident_state = (None, str(self.major_incident_state.value).encode(), "text/plain")
            # CHANGE END (3) #}
        else:
            major_incident_state: Union[Unset, tuple[None, bytes, str]] = UNSET
            if not isinstance(self.major_incident_state, Unset):
        ...
        if isinstance(self.major_incident_start_dt, Unset):
            ...
            if not isinstance(self.major_incident_start_dt, Unset):
                major_incident_start_dt = self.major_incident_start_dt.isoformat().encode()
        else:
            major_incident_start_dt = (None, str(self.major_incident_start_dt).encode(), "text/plain")
        ...
        if isinstance(self.nist_cvss_validation, Unset):
            ...
            if not isinstance(self.nist_cvss_validation, Unset):
                nist_cvss_validation = (None, str(self.nist_cvss_validation.value).encode(), "text/plain")
            # CHANGE END (3) #}
        else:
            nist_cvss_validation: Union[Unset, tuple[None, bytes, str]] = UNSET
            if not isinstance(self.nist_cvss_validation, Unset):
        ...
        group_key = (
            self.group_key if isinstance(self.group_key, Unset) else (None, str(self.group_key).encode(), "text/plain")
        )

        owner = self.owner if isinstance(self.owner, Unset) else (None, str(self.owner).encode(), "text/plain")

        task_key = (
            self.task_key if isinstance(self.task_key, Unset) else (None, str(self.task_key).encode(), "text/plain")
        )

        team_id = self.team_id if isinstance(self.team_id, Unset) else (None, str(self.team_id).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for acknowledgments_item_data in _acknowledgments or []:
            ...
            if isinstance(_acknowledgments_item, Unset):
                ...
                acknowledgments_item = FlawAcknowledgment.from_dict(_acknowledgments_item)
        ...
        def _parse_requires_cve_description(data: object) -> Union[BlankEnum, RequiresCveDescriptionEnum, Unset]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
            ...
            if isinstance(_requires_cve_description_type_1, Unset):
                ...
                requires_cve_description_type_1 = BlankEnum(_requires_cve_description_type_1)

            return requires_cve_description_type_1

        requires_cve_description = _parse_requires_cve_description(d.pop("requires_cve_description", UNSET))
        ...
        def _parse_major_incident_state(data: object) -> Union[BlankEnum, MajorIncidentStateEnum, Unset]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
        ...
        major_incident_state = _parse_major_incident_state(d.pop("major_incident_state", UNSET))

        def _parse_major_incident_start_dt(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                if isinstance(_major_incident_start_dt_type_0, Unset):
                    ...
                    major_incident_start_dt_type_0 = isoparse(_major_incident_start_dt_type_0)
        ...
        major_incident_start_dt = _parse_major_incident_start_dt(d.pop("major_incident_start_dt", UNSET))

        def _parse_nist_cvss_validation(data: object) -> Union[BlankEnum, NistCvssValidationEnum, Unset]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                ...
                if isinstance(_nist_cvss_validation_type_0, Unset):
                    ...
                    nist_cvss_validation_type_0 = NistCvssValidationEnum(_nist_cvss_validation_type_0)
        ...
        nist_cvss_validation = _parse_nist_cvss_validation(d.pop("nist_cvss_validation", UNSET))
