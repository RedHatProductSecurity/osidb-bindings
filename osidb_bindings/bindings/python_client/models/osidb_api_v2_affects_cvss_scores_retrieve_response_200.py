...
T = TypeVar("T", bound="OsidbApiV2AffectsCvssScoresRetrieveResponse200")


@_attrs_define
class OsidbApiV2AffectsCvssScoresRetrieveResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_affects_cvss_scores_retrieve_response_200 = cls(
        ...
        osidb_api_v2_affects_cvss_scores_retrieve_response_200.additional_properties = d
        return osidb_api_v2_affects_cvss_scores_retrieve_response_200
