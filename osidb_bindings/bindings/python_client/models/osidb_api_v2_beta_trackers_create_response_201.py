...
T = TypeVar("T", bound="OsidbApiV2BetaTrackersCreateResponse201")


@_attrs_define
class OsidbApiV2BetaTrackersCreateResponse201(OSIDBModel):
    """
    Attributes:
        affects (list[UUID]):
        cve_id (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_beta_trackers_create_response_201 = cls(
            affects=affects,
            cve_id=cve_id,
            errata=errata,
        ...
        osidb_api_v2_beta_trackers_create_response_201.additional_properties = d
        return osidb_api_v2_beta_trackers_create_response_201
