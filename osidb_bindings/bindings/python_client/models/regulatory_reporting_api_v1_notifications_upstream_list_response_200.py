...
if TYPE_CHECKING:
    from ..models.upstream_notification import UpstreamNotification


T = TypeVar("T", bound="RegulatoryReportingApiV1NotificationsUpstreamListResponse200")


@_attrs_define
class RegulatoryReportingApiV1NotificationsUpstreamListResponse200(OSIDBModel):
    """
    Attributes:
        count (int):  Example: 123.
        results (list['UpstreamNotification']):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            results_item: UpstreamNotification
            if isinstance(_results_item, Unset):
                results_item = UNSET
            else:
                results_item = UpstreamNotification.from_dict(_results_item)
        ...
        regulatory_reporting_api_v1_notifications_upstream_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        regulatory_reporting_api_v1_notifications_upstream_list_response_200.additional_properties = d
        return regulatory_reporting_api_v1_notifications_upstream_list_response_200
