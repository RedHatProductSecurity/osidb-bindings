...
T = TypeVar("T", bound="RegulatoryReportingApiV1SrpReportsCreateResponse201")


@_attrs_define
class RegulatoryReportingApiV1SrpReportsCreateResponse201(OSIDBModel):
    """
    Attributes:
        uuid (UUID):
        flaw_id (UUID): UUID of the flaw to create an SRP report for
        reportable_event_type (ReportableEventTypeEnum):
        status (SRPReportStatusEnum):
        evidence (str):
        timer_started_at (Union[None, datetime.datetime]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        timer_started_at: Union[None, str]
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_timer_started_at(data: object) -> Union[None, datetime.datetime]:
            if data is None:
                return data
        ...
        regulatory_reporting_api_v1_srp_reports_create_response_201 = cls(
            uuid=uuid,
            flaw_id=flaw_id,
        ...
        regulatory_reporting_api_v1_srp_reports_create_response_201.additional_properties = d
        return regulatory_reporting_api_v1_srp_reports_create_response_201
