...
T = TypeVar(
    "T", bound="RegulatoryReportingApiV1SrpReportsMilestonesRetrieveResponse200"
)


@_attrs_define
class RegulatoryReportingApiV1SrpReportsMilestonesRetrieveResponse200(OSIDBModel):
    """
    Attributes:
        uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        regulatory_reporting_api_v1_srp_reports_milestones_retrieve_response_200 = cls(
            uuid=uuid,
        ...
        regulatory_reporting_api_v1_srp_reports_milestones_retrieve_response_200.additional_properties = d
        return regulatory_reporting_api_v1_srp_reports_milestones_retrieve_response_200
