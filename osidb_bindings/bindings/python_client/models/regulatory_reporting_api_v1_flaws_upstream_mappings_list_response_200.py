...
if TYPE_CHECKING:
    from ..models.flaw_upstream_mapping import FlawUpstreamMapping


T = TypeVar("T", bound="RegulatoryReportingApiV1FlawsUpstreamMappingsListResponse200")


@_attrs_define
class RegulatoryReportingApiV1FlawsUpstreamMappingsListResponse200(OSIDBModel):
    """
    Attributes:
        count (int):  Example: 123.
        results (list['FlawUpstreamMapping']):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            results_item: FlawUpstreamMapping
            if isinstance(_results_item, Unset):
                results_item = UNSET
            else:
                results_item = FlawUpstreamMapping.from_dict(_results_item)
        ...
        regulatory_reporting_api_v1_flaws_upstream_mappings_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        regulatory_reporting_api_v1_flaws_upstream_mappings_list_response_200.additional_properties = d
        return regulatory_reporting_api_v1_flaws_upstream_mappings_list_response_200
