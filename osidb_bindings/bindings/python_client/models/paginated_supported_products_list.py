...
class PaginatedSupportedProductsList(OSIDBModel):
    ...
    results: Union[Unset, List[SupportedProducts]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _results is UNSET:
            ...
            for results_item_data in _results or []:
                ...
                results_item: SupportedProducts
                if isinstance(_results_item, Unset):
                    results_item = UNSET
                else:
                    results_item = SupportedProducts.from_dict(_results_item)

                results.append(results_item)

        paginated_supported_products_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
