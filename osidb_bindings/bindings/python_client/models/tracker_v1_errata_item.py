...
T = TypeVar("T", bound="TrackerV1ErrataItem")


@_attrs_define
class TrackerV1ErrataItem(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        tracker_v1_errata_item.additional_properties = d
        return tracker_v1_errata_item
