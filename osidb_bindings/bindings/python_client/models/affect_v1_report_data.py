...
T = TypeVar("T", bound="AffectV1ReportData")


@_attrs_define
class AffectV1ReportData(OSIDBModel):
    """
    Attributes:
        ps_module (str):
        ps_component (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        affect_v1_report_data.additional_properties = d
        return affect_v1_report_data
