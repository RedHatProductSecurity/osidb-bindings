...
T = TypeVar("T", bound="RegulatoryReportingApiV1FlawsSrpReportsListResponse200")


@_attrs_define
class RegulatoryReportingApiV1FlawsSrpReportsListResponse200(OSIDBModel):
    """
    Attributes:
        count (int):  Example: 123.
        results (list['SRPReport']):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            results_item: SRPReport
            if isinstance(_results_item, Unset):
                results_item = UNSET
            else:
                results_item = SRPReport.from_dict(_results_item)
        ...
        regulatory_reporting_api_v1_flaws_srp_reports_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        regulatory_reporting_api_v1_flaws_srp_reports_list_response_200.additional_properties = d
        return regulatory_reporting_api_v1_flaws_srp_reports_list_response_200
