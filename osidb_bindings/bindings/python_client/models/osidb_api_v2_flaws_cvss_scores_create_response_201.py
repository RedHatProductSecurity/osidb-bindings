...
T = TypeVar("T", bound="OsidbApiV2FlawsCvssScoresCreateResponse201")


@_attrs_define
class OsidbApiV2FlawsCvssScoresCreateResponse201(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_flaws_cvss_scores_create_response_201 = cls(
        ...
        osidb_api_v2_flaws_cvss_scores_create_response_201.additional_properties = d
        return osidb_api_v2_flaws_cvss_scores_create_response_201
