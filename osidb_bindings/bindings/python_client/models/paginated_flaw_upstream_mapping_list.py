...
T = TypeVar("T", bound="PaginatedFlawUpstreamMappingList")


@_attrs_define
class PaginatedFlawUpstreamMappingList(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        paginated_flaw_upstream_mapping_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_flaw_upstream_mapping_list.additional_properties = d
        return paginated_flaw_upstream_mapping_list
