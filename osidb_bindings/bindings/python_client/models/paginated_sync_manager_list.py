...
T = TypeVar("T", bound="PaginatedSyncManagerList")


@_attrs_define
class PaginatedSyncManagerList(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        paginated_sync_manager_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_sync_manager_list.additional_properties = d
        return paginated_sync_manager_list
