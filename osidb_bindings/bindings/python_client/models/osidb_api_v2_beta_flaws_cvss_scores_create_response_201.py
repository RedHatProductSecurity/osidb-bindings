...
T = TypeVar("T", bound="OsidbApiV2BetaFlawsCvssScoresCreateResponse201")


@_attrs_define
class OsidbApiV2BetaFlawsCvssScoresCreateResponse201(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_beta_flaws_cvss_scores_create_response_201 = cls(
