...
T = TypeVar("T", bound="FlawPackageVersionPost")


@_attrs_define
class FlawPackageVersionPost(OSIDBModel):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        flaw_package_version_post.additional_properties = d
