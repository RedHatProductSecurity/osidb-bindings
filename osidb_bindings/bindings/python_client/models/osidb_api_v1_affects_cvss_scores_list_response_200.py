...
T = TypeVar("T", bound="OsidbApiV1AffectsCvssScoresListResponse200")


@_attrs_define
class OsidbApiV1AffectsCvssScoresListResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v1_affects_cvss_scores_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
