...
T = TypeVar("T", bound="RegulatoryReportingApiV1FlawsUpstreamMappingsCreateResponse201")


@_attrs_define
class RegulatoryReportingApiV1FlawsUpstreamMappingsCreateResponse201(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        regulatory_reporting_api_v1_flaws_upstream_mappings_create_response_201 = cls(
        ...
        regulatory_reporting_api_v1_flaws_upstream_mappings_create_response_201.additional_properties = d
        return regulatory_reporting_api_v1_flaws_upstream_mappings_create_response_201
