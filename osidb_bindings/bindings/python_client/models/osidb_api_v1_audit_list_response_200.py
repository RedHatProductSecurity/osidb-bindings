...
T = TypeVar("T", bound="OsidbApiV1AuditListResponse200")


@attr.s(auto_attribs=True)
class OsidbApiV1AuditListResponse200(OSIDBModel):
    """ """

    count: Union[Unset, int] = UNSET
    next_: Union[Unset, None, str] = UNSET
    previous: Union[Unset, None, str] = UNSET
    results: Union[Unset, List[Audit]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _results is UNSET:
            ...
            for results_item_data in _results or []:
                ...
                if isinstance(_results_item, Unset):
                    ...
                    results_item = Audit.from_dict(_results_item)
        ...
        osidb_api_v1_audit_list_response_200 = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
