...
T = TypeVar("T", bound="RegulatoryReportingApiV1UpstreamProjectsRetrieveResponse200")


@_attrs_define
class RegulatoryReportingApiV1UpstreamProjectsRetrieveResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        regulatory_reporting_api_v1_upstream_projects_retrieve_response_200 = cls(
        ...
        regulatory_reporting_api_v1_upstream_projects_retrieve_response_200.additional_properties = d
        return regulatory_reporting_api_v1_upstream_projects_retrieve_response_200
