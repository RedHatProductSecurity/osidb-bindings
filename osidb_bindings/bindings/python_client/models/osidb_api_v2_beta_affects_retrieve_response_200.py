...
T = TypeVar("T", bound="OsidbApiV2BetaAffectsRetrieveResponse200")


@_attrs_define
class OsidbApiV2BetaAffectsRetrieveResponse200(OSIDBModel):
    """
    Attributes:
        uuid (UUID):
        flaw (UUID):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_beta_affects_retrieve_response_200 = cls(
            uuid=uuid,
            flaw=flaw,
        ...
        osidb_api_v2_beta_affects_retrieve_response_200.additional_properties = d
        return osidb_api_v2_beta_affects_retrieve_response_200
