...
T = TypeVar("T", bound="RegulatoryReportingApiV1SrpReportsMilestonesCreateResponse201")


@_attrs_define
class RegulatoryReportingApiV1SrpReportsMilestonesCreateResponse201(OSIDBModel):
    """
    Attributes:
        uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        regulatory_reporting_api_v1_srp_reports_milestones_create_response_201 = cls(
            uuid=uuid,
        ...
        regulatory_reporting_api_v1_srp_reports_milestones_create_response_201.additional_properties = d
        return regulatory_reporting_api_v1_srp_reports_milestones_create_response_201
