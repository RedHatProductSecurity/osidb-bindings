...
T = TypeVar("T", bound="PaginatedAffectV1List")


@_attrs_define
class PaginatedAffectV1List(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        paginated_affect_v1_list.additional_properties = d
        return paginated_affect_v1_list
