...
T = TypeVar("T", bound="UpstreamProjectRequest")


@_attrs_define
class UpstreamProjectRequest(OSIDBModel):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        upstream_project_request.additional_properties = d
        return upstream_project_request
