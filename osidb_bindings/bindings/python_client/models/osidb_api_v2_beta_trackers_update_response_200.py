...
T = TypeVar("T", bound="OsidbApiV2BetaTrackersUpdateResponse200")


@_attrs_define
class OsidbApiV2BetaTrackersUpdateResponse200(OSIDBModel):
    """
    Attributes:
        affects (list[UUID]):
        cve_id (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_beta_trackers_update_response_200 = cls(
            affects=affects,
            cve_id=cve_id,
            errata=errata,
        ...
        osidb_api_v2_beta_trackers_update_response_200.additional_properties = d
        return osidb_api_v2_beta_trackers_update_response_200
