...
T = TypeVar("T", bound="OsidbApiV2BetaAffectsCvssScoresRetrieveResponse200")


@_attrs_define
class OsidbApiV2BetaAffectsCvssScoresRetrieveResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_beta_affects_cvss_scores_retrieve_response_200 = cls(
