...
T = TypeVar("T", bound="RegulatoryReportingApiV1SrpReportsUpdateResponse200")


@_attrs_define
class RegulatoryReportingApiV1SrpReportsUpdateResponse200(OSIDBModel):
    """
    Attributes:
        uuid (UUID):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        regulatory_reporting_api_v1_srp_reports_update_response_200 = cls(
            uuid=uuid,
            flaw_id=flaw_id,
            title=title,
        ...
        regulatory_reporting_api_v1_srp_reports_update_response_200.additional_properties = d
        return regulatory_reporting_api_v1_srp_reports_update_response_200
