...
T = TypeVar("T", bound="SRPReportMilestone")


@_attrs_define
class SRPReportMilestone(OSIDBModel):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        srp_report_milestone.additional_properties = d
        return srp_report_milestone
