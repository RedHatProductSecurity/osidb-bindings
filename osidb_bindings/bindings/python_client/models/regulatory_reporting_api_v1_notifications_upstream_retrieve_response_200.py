...
T = TypeVar(
    "T", bound="RegulatoryReportingApiV1NotificationsUpstreamRetrieveResponse200"
)


@_attrs_define
class RegulatoryReportingApiV1NotificationsUpstreamRetrieveResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        regulatory_reporting_api_v1_notifications_upstream_retrieve_response_200 = cls(
            embargoed=embargoed,
        ...
        regulatory_reporting_api_v1_notifications_upstream_retrieve_response_200.additional_properties = d
        return regulatory_reporting_api_v1_notifications_upstream_retrieve_response_200
