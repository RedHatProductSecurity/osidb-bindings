...
T = TypeVar("T", bound="FlawV1Request")


@_attrs_define
class FlawV1Request(OSIDBModel):
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        aegis_meta = (
            self.aegis_meta
            if isinstance(self.aegis_meta, Unset)
            else (None, str(self.aegis_meta).encode(), "text/plain")
        )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        flaw_v1_request.additional_properties = d
        return flaw_v1_request
