...
T = TypeVar("T", bound="OsidbApiV1SyncManagersListResponse200")


@_attrs_define
class OsidbApiV1SyncManagersListResponse200(OSIDBModel):
    """
    Attributes:
        count (int):  Example: 123.
        results (list['SyncManager']):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            results_item: SyncManager
            if isinstance(_results_item, Unset):
                results_item = UNSET
            else:
                results_item = SyncManager.from_dict(_results_item)
        ...
        osidb_api_v1_sync_managers_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        osidb_api_v1_sync_managers_list_response_200.additional_properties = d
        return osidb_api_v1_sync_managers_list_response_200
