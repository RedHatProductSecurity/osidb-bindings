...
T = TypeVar("T", bound="RegulatoryReportingApiV1SrpReportsMilestonesListResponse200")


@_attrs_define
class RegulatoryReportingApiV1SrpReportsMilestonesListResponse200(OSIDBModel):
    """
    Attributes:
        count (int):  Example: 123.
        results (list['SRPReportMilestone']):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            results_item: SRPReportMilestone
            if isinstance(_results_item, Unset):
                results_item = UNSET
            else:
                results_item = SRPReportMilestone.from_dict(_results_item)
        ...
        regulatory_reporting_api_v1_srp_reports_milestones_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        regulatory_reporting_api_v1_srp_reports_milestones_list_response_200.additional_properties = d
        return regulatory_reporting_api_v1_srp_reports_milestones_list_response_200
