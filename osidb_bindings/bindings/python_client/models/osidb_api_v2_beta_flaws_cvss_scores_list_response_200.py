...
T = TypeVar("T", bound="OsidbApiV2BetaFlawsCvssScoresListResponse200")


@_attrs_define
class OsidbApiV2BetaFlawsCvssScoresListResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_beta_flaws_cvss_scores_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
