...
T = TypeVar("T", bound="PaginatedFlawCommentList")


@attr.s(auto_attribs=True)
class PaginatedFlawCommentList(OSIDBModel):
    """ """

    count: Union[Unset, int] = UNSET
    next_: Union[Unset, None, str] = UNSET
    previous: Union[Unset, None, str] = UNSET
    results: Union[Unset, List[FlawComment]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        paginated_flaw_comment_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
