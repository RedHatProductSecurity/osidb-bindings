...
T = TypeVar("T", bound="PaginatedTrackerV1List")


@_attrs_define
class PaginatedTrackerV1List(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        paginated_tracker_v1_list.additional_properties = d
        return paginated_tracker_v1_list
