...
if TYPE_CHECKING:
    ...
    from ..models.tracker_errata_item import TrackerErrataItem


T = TypeVar("T", bound="OsidbApiV2TrackersRetrieveResponse200")


@_attrs_define
class OsidbApiV2TrackersRetrieveResponse200(OSIDBModel):
    """
    Attributes:
        affects (list[UUID]):
        cve_id (str):
        errata (list['TrackerErrataItem']):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for errata_item_data in _errata or []:
            ...
            errata_item: TrackerErrataItem
            if isinstance(_errata_item, Unset):
                errata_item = UNSET
            else:
                errata_item = TrackerErrataItem.from_dict(_errata_item)
        ...
        osidb_api_v2_trackers_retrieve_response_200 = cls(
            affects=affects,
            cve_id=cve_id,
            errata=errata,
        ...
        osidb_api_v2_trackers_retrieve_response_200.additional_properties = d
        return osidb_api_v2_trackers_retrieve_response_200
