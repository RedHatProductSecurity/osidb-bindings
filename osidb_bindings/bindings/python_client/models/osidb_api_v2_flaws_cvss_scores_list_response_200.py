...
if TYPE_CHECKING:
    from ..models.flaw_cvssv2 import FlawCVSSV2


T = TypeVar("T", bound="OsidbApiV2FlawsCvssScoresListResponse200")


@_attrs_define
class OsidbApiV2FlawsCvssScoresListResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            results_item: FlawCVSSV2
            if isinstance(_results_item, Unset):
                results_item = UNSET
            else:
                results_item = FlawCVSSV2.from_dict(_results_item)
        ...
        osidb_api_v2_flaws_cvss_scores_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        osidb_api_v2_flaws_cvss_scores_list_response_200.additional_properties = d
        return osidb_api_v2_flaws_cvss_scores_list_response_200
