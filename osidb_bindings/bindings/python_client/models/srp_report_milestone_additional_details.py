...
T = TypeVar("T", bound="SRPReportMilestoneAdditionalDetails")


@_attrs_define
class SRPReportMilestoneAdditionalDetails(OSIDBModel):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        srp_report_milestone_additional_details = cls()

        srp_report_milestone_additional_details.additional_properties = d
        return srp_report_milestone_additional_details
