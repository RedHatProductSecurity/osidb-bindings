...
T = TypeVar("T", bound="PaginatedSRPReportMilestoneList")


@_attrs_define
class PaginatedSRPReportMilestoneList(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        paginated_srp_report_milestone_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_srp_report_milestone_list.additional_properties = d
        return paginated_srp_report_milestone_list
