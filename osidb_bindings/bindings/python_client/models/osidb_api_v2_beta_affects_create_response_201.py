...
T = TypeVar("T", bound="OsidbApiV2BetaAffectsCreateResponse201")


@_attrs_define
class OsidbApiV2BetaAffectsCreateResponse201(OSIDBModel):
    """
    Attributes:
        uuid (UUID):
        flaw (UUID):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_beta_affects_create_response_201 = cls(
            uuid=uuid,
            flaw=flaw,
        ...
        osidb_api_v2_beta_affects_create_response_201.additional_properties = d
        return osidb_api_v2_beta_affects_create_response_201
