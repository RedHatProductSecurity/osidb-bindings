...
T = TypeVar("T", bound="PaginatedUpstreamProjectList")


@_attrs_define
class PaginatedUpstreamProjectList(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        paginated_upstream_project_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_upstream_project_list.additional_properties = d
        return paginated_upstream_project_list
