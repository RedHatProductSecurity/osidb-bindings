...
T = TypeVar("T", bound="UpstreamNotification")


@_attrs_define
class UpstreamNotification(OSIDBModel):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        upstream_notification.additional_properties = d
        return upstream_notification
