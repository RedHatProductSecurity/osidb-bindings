...
class CollectorsApiV1StatusRetrieveResponse200CollectorsItem(OSIDBModel):
    ...
    error: Union["CollectorsApiV1StatusRetrieveResponse200CollectorsItemErrorType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.error, Unset):
            error = UNSET
        elif isinstance(self.error, CollectorsApiV1StatusRetrieveResponse200CollectorsItemErrorType0):
            error = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_error(
            data: object,
        ) -> Union["CollectorsApiV1StatusRetrieveResponse200CollectorsItemErrorType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                # }
                _error_type_0 = data
                error_type_0: CollectorsApiV1StatusRetrieveResponse200CollectorsItemErrorType0
                ...
                pass
            return cast(Union["CollectorsApiV1StatusRetrieveResponse200CollectorsItemErrorType0", None, Unset], data)
    ...
    def get_fields():
        return {
            ...
            "depends_on": list[str],
            "error": Union["CollectorsApiV1StatusRetrieveResponse200CollectorsItemErrorType0", None],
            "is_complete": bool,
            "is_up2date": bool,
