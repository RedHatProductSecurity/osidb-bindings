...
T = TypeVar(
    "T", bound="RegulatoryReportingApiV1NotificationsUpstreamSendEmailCreateResponse200"
)


@_attrs_define
class RegulatoryReportingApiV1NotificationsUpstreamSendEmailCreateResponse200(
    OSIDBModel
):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        regulatory_reporting_api_v1_notifications_upstream_send_email_create_response_200 = cls(
            embargoed=embargoed,
        ...
        regulatory_reporting_api_v1_notifications_upstream_send_email_create_response_200.additional_properties = d
        return regulatory_reporting_api_v1_notifications_upstream_send_email_create_response_200
