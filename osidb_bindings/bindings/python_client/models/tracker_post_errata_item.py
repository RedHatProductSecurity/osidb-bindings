...
T = TypeVar("T", bound="TrackerPostErrataItem")


@_attrs_define
class TrackerPostErrataItem(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        tracker_post_errata_item.additional_properties = d
        return tracker_post_errata_item
