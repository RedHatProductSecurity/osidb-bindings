...
T = TypeVar("T", bound="UpstreamProjectPost")


@_attrs_define
class UpstreamProjectPost(OSIDBModel):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        upstream_project_post.additional_properties = d
        return upstream_project_post
