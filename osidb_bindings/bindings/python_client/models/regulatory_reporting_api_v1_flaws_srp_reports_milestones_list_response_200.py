...
T = TypeVar(
    "T", bound="RegulatoryReportingApiV1FlawsSrpReportsMilestonesListResponse200"
)


@_attrs_define
class RegulatoryReportingApiV1FlawsSrpReportsMilestonesListResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        regulatory_reporting_api_v1_flaws_srp_reports_milestones_list_response_200 = (
            cls(
                count=count,
                results=results,
                next_=next_,
        ...
        regulatory_reporting_api_v1_flaws_srp_reports_milestones_list_response_200.additional_properties = d
        return (
            regulatory_reporting_api_v1_flaws_srp_reports_milestones_list_response_200
        )
