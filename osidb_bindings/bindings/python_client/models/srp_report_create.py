...
T = TypeVar("T", bound="SRPReportCreate")


@_attrs_define
class SRPReportCreate(OSIDBModel):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        srp_report_create.additional_properties = d
        return srp_report_create
