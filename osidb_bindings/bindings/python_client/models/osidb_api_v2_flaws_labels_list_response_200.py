...
@_attrs_define
class OsidbApiV2FlawsLabelsListResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_flaws_labels_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        osidb_api_v2_flaws_labels_list_response_200.additional_properties = d
        return osidb_api_v2_flaws_labels_list_response_200
