...
if TYPE_CHECKING:
    from ..models.flaw_v1_report_data import FlawV1ReportData


T = TypeVar("T", bound="PaginatedFlawV1ReportDataList")


@_attrs_define
class PaginatedFlawV1ReportDataList(OSIDBModel):
    """
    Attributes:
        count (int):  Example: 123.
        results (list['FlawV1ReportData']):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            results_item: FlawV1ReportData
            if isinstance(_results_item, Unset):
                results_item = UNSET
            else:
                results_item = FlawV1ReportData.from_dict(_results_item)
        ...
        paginated_flaw_v1_report_data_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_flaw_v1_report_data_list.additional_properties = d
        return paginated_flaw_v1_report_data_list
