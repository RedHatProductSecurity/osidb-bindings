...
T = TypeVar("T", bound="OsidbApiV1FlawsCvssScoresListResponse200")


@attr.s(auto_attribs=True)
class OsidbApiV1FlawsCvssScoresListResponse200(OSIDBModel):
    """ """

    count: Union[Unset, int] = UNSET
    next_: Union[Unset, None, str] = UNSET
    previous: Union[Unset, None, str] = UNSET
    results: Union[Unset, List[FlawCVSS]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        osidb_api_v1_flaws_cvss_scores_list_response_200 = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
