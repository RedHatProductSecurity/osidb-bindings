...
T = TypeVar("T", bound="OsidbApiV2BetaAffectsCvssScoresCreateResponse201")


@_attrs_define
class OsidbApiV2BetaAffectsCvssScoresCreateResponse201(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_beta_affects_cvss_scores_create_response_201 = cls(
