...
T = TypeVar("T", bound="OsidbApiV2FlawsCreateResponse201")


@_attrs_define
class OsidbApiV2FlawsCreateResponse201(OSIDBModel):
    """
    Attributes:
        uuid (UUID):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_flaws_create_response_201 = cls(
            uuid=uuid,
            title=title,
            trackers=trackers,
        ...
        osidb_api_v2_flaws_create_response_201.additional_properties = d
        return osidb_api_v2_flaws_create_response_201
