...
if TYPE_CHECKING:
    from ..models.affect_cvssv2 import AffectCVSSV2


T = TypeVar("T", bound="OsidbApiV2AffectsCvssScoresListResponse200")


@_attrs_define
class OsidbApiV2AffectsCvssScoresListResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            results_item: AffectCVSSV2
            if isinstance(_results_item, Unset):
                results_item = UNSET
            else:
                results_item = AffectCVSSV2.from_dict(_results_item)
        ...
        osidb_api_v2_affects_cvss_scores_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        osidb_api_v2_affects_cvss_scores_list_response_200.additional_properties = d
        return osidb_api_v2_affects_cvss_scores_list_response_200
