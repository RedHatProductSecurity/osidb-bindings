...
T = TypeVar("T", bound="OsidbApiV1FlawsLabelsListResponse200")


@_attrs_define
class OsidbApiV1FlawsLabelsListResponse200(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            results_item: FlawCollaborator
            if isinstance(_results_item, Unset):
                results_item = UNSET
            else:
                results_item = FlawCollaborator.from_dict(_results_item)
        ...
        osidb_api_v1_flaws_labels_list_response_200 = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
