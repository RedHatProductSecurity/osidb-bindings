...
@_attrs_define
class OsidbApiV2AffectsBulkCreateResponse200(OSIDBModel):
    """
    Attributes:
        results (list['Affect']):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_affects_bulk_create_response_200.additional_properties = d
        return osidb_api_v2_affects_bulk_create_response_200
