...
if TYPE_CHECKING:
    from ..models.flaw_v1 import FlawV1


T = TypeVar("T", bound="PaginatedFlawV1List")


@_attrs_define
class PaginatedFlawV1List(OSIDBModel):
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            ...
            if isinstance(_results_item, Unset):
                ...
                results_item = FlawV1.from_dict(_results_item)
        ...
        paginated_flaw_v1_list.additional_properties = d
        return paginated_flaw_v1_list
