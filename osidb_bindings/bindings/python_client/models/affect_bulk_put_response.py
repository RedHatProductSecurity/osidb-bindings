...
T = TypeVar("T", bound="AffectBulkPutResponse")


@attr.s(auto_attribs=True)
class AffectBulkPutResponse(OSIDBModel):
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        affect_bulk_put_response = cls(
            results=results,
        )

        affect_bulk_put_response.additional_properties = d
        return affect_bulk_put_response
