...
T = TypeVar("T", bound="OsidbApiV2FlawsLabelsCreateResponse201")


@_attrs_define
class OsidbApiV2FlawsLabelsCreateResponse201(OSIDBModel):
    """
    Attributes:
        uuid (UUID):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        osidb_api_v2_flaws_labels_create_response_201 = cls(
            uuid=uuid,
            name=name,
            type_=type_,
            state=state,
        ...
        osidb_api_v2_flaws_labels_create_response_201.additional_properties = d
        return osidb_api_v2_flaws_labels_create_response_201
