...
## [5.8.1] - 2026-04-08
### Changed
- unified API version resolution for extra operations (promote, reject, reset, revert, file, status) to use dynamic version selection
...
## [5.5.0] - 2026-03-03
### Added
- JIRA_API_EMAIL environment variable
...
- default to latest endpoint version (OSIDB-4413)
...
## [4.13.0] - 2025-07-14
### Fixed
- python lists for list query parameters are now supported
...
- add CRUD operations for Flaw Labels (Collaborators)
