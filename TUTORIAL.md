...
* #### ```retrieve_list```
    ...
    only_specified_fields_flaws_response = session.flaws.retrieve_list(include_fields="cve_id,uuid,impact")
...
* #### ```retrieve_list_iterator_async```
    Retrieve a list of Flaws. Handles the pagination and returns the generator of individual resource entities. Uses asynchronous communication
